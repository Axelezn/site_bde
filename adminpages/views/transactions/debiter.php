...
<head>
    ...
    <title>Débiter un Compte - BDE ADMIN</title>
...
<body>
    <div class="container">
        ...
        <form action="/adminpages/index.php?action=debiter_compte" method="post">
            <div class="form-group">
                <label for="compte_id">Compte à débiter:</label>
            ...
            <div class="form-group">
                <label for="montant">Montant à débiter:</label>
            ...
            <button type="submit" class="button primary">Débiter</button>
